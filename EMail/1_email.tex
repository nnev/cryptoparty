...
\subsection*{Was'n los mit Email}
...
\demoframe
\note{Demo1: Show how easily the content of a mail can be read by a sysadmin}

\begin{frame}{State of the Art: 1980}
	\begin{tikzpicture}[
			node distance = 0cm,
			pre/.style={<-,shorten <=1pt,>=stealth',semithick},
			post/.style={->,shorten >=1pt,>=stealth',semithick}
...
\demoframe
\note {Demo2: Pass around a locked postcard}
